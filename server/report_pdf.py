"""
SAT-SA supervisory report -- fixed professional PDF format
==============================================================
...
def _styles():
    ...
    ss.add(ParagraphStyle("SATTitle", parent=ss["Title"], fontSize=20, textColor=colors.HexColor("#16233f"), spaceAfter=2))
...
def build_report_pdf(entity, assessment_date, generated_at, review_period_days):
    ...
    # ---- Header -----------------------------------------------------
    story.append(Paragraph("SAT-SA Supervisory Assessment Report", ss["SATTitle"]))
    ...
    story.append(HRFlowable(width="100%", thickness=1, color=colors.HexColor("#dfe4ee")))
    story.append(Paragraph(
        "This report is generated by SAT-SA to assist supervisory judgement and does not replace it. "
