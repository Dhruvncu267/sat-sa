...
// Session-only persistence: signing in survives page reloads/navigation
// within the same browser tab (so the login -> dashboard redirect still
// works), but is gone the moment the tab/browser is closed -- so reopening
// the site always asks to log in again, on purpose (matches login.js).
