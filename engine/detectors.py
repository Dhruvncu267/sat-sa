...
class Flag:
    ...
    def to_dict(self):
        return {
            ...
            # Informational only -- see engine/regulatory.py's module
            # docstring. None for most findings, which is expected: only a
            # few detectors have a genuine, specific CERT-In correspondence.
            "cert_in": regulatory.cert_in_reference(self.rule_id),
        }
