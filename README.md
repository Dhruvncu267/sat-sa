...
Go to `https://sat-sa.onrender.com` (your own web address), click **"Create an account"** on the login page, fill in your name, email, and a password, and click **Create account &amp; log in** — you're immediately signed in.
...
`https://sat-sa.onrender.com/setup?token=...`, where `...` is the
